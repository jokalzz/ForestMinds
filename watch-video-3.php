...
$video_id = isset($_GET['video_id']) ? intval($_GET['video_id']) : 3;
            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <div>
                  ...
                  <p class="item-text">
                  Plastik menjadi bagian penting dalam kehidupan sehari-hari, 
                  tetapi membawa masalah besar bagi lingkungan. Setiap tahun, ratusan juta ton plastik diproduksi, 
                  dan 8 juta ton dibuang ke laut, membutuhkan ratusan tahun untuk terurai. Pada 2050, 
                  jumlah plastik di laut diperkirakan melebihi jumlah hewan laut.
                  </p>
                  <h4 class="h4-2"> Dampak: </h4>
                  <p class="item-text">
                  <br><strong>- Membahayakan hewan liar.</strong>
                  </p>
                  <p class="item-text">
                  <br><strong>- Mikroplastik masuk ke rantai makanan, berisiko bagi kesehatan manusia.</strong>
                  </p>
                  <h4 class="h4-2"> Solusi: </h4>
                  <p class="item-text">
                  <br>- Mikroplastik masuk ke rantai makanan, berisiko bagi kesehatan manusia.</strong>
                  </p>
                  <p class="item-text">
                  <br>- Mikroplastik masuk ke rantai makanan, berisiko bagi kesehatan manusia.</strong>
                  </p>
                  ...
                  <p class="item-text">
                  <br>Kesimpulannya, plastik memang telah menjadi bagian yang tak terpisahkan dari kehidupan modern, namun dampak negatifnya terhadap lingkungan sangat besar dan memprihatinkan. Setiap tahun, produksi plastik terus meningkat pesat, dengan sebagian besar sampah plastik berakhir di laut, mencemari ekosistem laut dan membahayakan kehidupan hewan-hewan laut. Selain itu, mikroplastik yang terbawa ke dalam rantai makanan juga berisiko bagi kesehatan manusia. Jika tidak ditangani dengan serius, pada tahun 2050, jumlah plastik di laut diperkirakan akan melebihi jumlah hewan laut, memperburuk krisis lingkungan global.
                  </p>
                </div>
