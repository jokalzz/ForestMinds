            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <div>
                  ...
                  <p class="item-text">
Masalah lingkungan yang sering terabaikan adalah dampak besar dari bangunan, 
terutama penggunaan beton. Beton, bahan yang paling banyak digunakan di dunia setelah air, 
memiliki jejak karbon tinggi, terutama dari proses produksi semen—penyumbang emisi terbesar 
ketiga di dunia jika dianggap sebagai negara.
                  </p>
                  <p class="item-text">
                  <br>Beton telah menjadi bagian penting sejarah manusia sejak zaman Yunani dan Romawi kuno. 
                  Penggunaannya terus meningkat seiring pertumbuhan populasi dan ekonomi. 
                  Meski sulit dihindari, ada cara untuk mengurangi dampaknya:
                  </p>
                  <p class="item-text">
                  <br><strong>- Mengurangi penggunaan beton.</strong>
                  </p>
                  <p class="item-text">
                  <strong>- Meningkatkan keberlanjutan produksi semen.</strong>
                  </p>
                  <p class="item-text">
                  <strong>- Merawat bangunan lama.</strong>
                  </p>
                  <p class="item-text">
                  <strong>- Mengadopsi bangunan hijau.</strong>
                  </p>
                  <p class="item-text">
                  <br>Kesimpulannya, meskipun beton telah menjadi bahan bangunan utama di dunia, 
                  dampaknya terhadap lingkungan sangat signifikan dan memerlukan perhatian serius. 
                  Namun, solusi-solusi untuk mengurangi dampaknya sudah ada dan dapat diterapkan dengan perubahan besar dalam cara kita merancang, 
                  membangun, dan menggunakan bahan bangunan. Dengan langkah-langkah yang lebih berkelanjutan dan efisien, 
                  kita dapat menciptakan bangunan yang lebih ramah lingkungan dan membantu mengurangi jejak karbon industri 
                  konstruksi demi masa depan yang lebih hijau dan lebih baik.
                  </p>
                </div>
