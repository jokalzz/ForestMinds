            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <div>
                  ...
                  <p class="item-text">
                  Pandemi COVID-19 dan kebakaran hutan adalah ancaman ganda bagi kesehatan manusia dan lingkungan.
                  <br>
                  <br>
                  <strong>Fakta utama:</strong>
                  <br>
                  - Polusi udara sempat berkurang saat awal lockdown,
                  <br>
                  - Sampah pandemi meningkat, seperti masker sekali pakai dan kemasan barang belanjaan.
                  <br>
                  - Kombinasi virus corona dan asap kebakaran hutan sangat berbahaya: 
                  <br>
                  <span class="spaced-tilde">> Keduanya menyerang sistem pernapasan.</span>
                  <span class="spaced-tilde">> Polusi udara memperparah dampak virus corona, seperti yang terbukti di beberapa negara.</span>
                  <span class="spaced-tilde">> Kebakaran hutan menyebabkan kabut asap yang merugikan jutaan orang.</span>
                  <br>
                  <b>Dampak kebakaran hutan:</b>  
                  <br>
                  - Mengusir hewan dari habitatnya, meningkatkan risiko penyebaran penyakit dari hewan ke manusia (zoonosis).
                  <br>
                  - Mengubah iklim lokal, memperburuk polusi Udara
                  <br>
                  - Merusak lingkungan, memperburuk krisis kesehatan.
                  <br>
                  <br>
                  <b>Solusi:</b>
                  <br>
                  - Lawan kebakaran hutan sekuat melawan virus.
                  <br>
                  - Edukasi masyarakat tentang bahaya kebakaran hutan dan pandemi.
                  <br>
                  - Dukung kampanye pelestarian hutan.
                  <br>
                  Melindungi hutan adalah langkah penting untuk mencegah dua ancaman ini.
                </p>
</div>
...
<style>
  .spaced-tilde {
    ...
    margin-left: 40px; /* Memberikan jarak antara karakter ~ dan teks */
    margin-right: 40px; /* Memberikan jarak antara karakter ~ dan teks */
  }
</style>
          </div>
