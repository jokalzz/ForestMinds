            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <div>
                  ...
                  <p class="item-text">
                  Indonesia memiliki tingkat polusi yang tinggi, yang berdampak buruk bagi kesehatan. Polusi udara berasal dari dua sumber utama:
                  <br>
                  <strong>- Point source:</strong> seperti emisi pabrik
                  <br>
                  <strong>- Non-point source:</strong> seperti emisi kendaraan bermotor
                  </p>
                  <br>
                  Polutan dibagi menjadi:
                  <br>
                  <strong>- Polutan primer:</strong> langsung merusak atau bereaksi di udara.
                  <br>
                  <strong>- Polutan sekunder:</strong> terbentuk dari reaksi polutan
                  <br>
                  <br>
                  Polusi udara memengaruhi paru-paru, jantung, dan otak. Polutan dapat:
                  <br>
                  - Menyebabkan peradangan paru-paru, asma, bronkitis, hingga kanker.
                  <br>
                  - Memasuki aliran darah, memicu peradangan pembuluh darah, stroke, hingga serangan jantung.
                  <br>
                  <br>
                  <strong>Kelompok rentan:</strong> penderita penyakit jantung/paru, ibu hamil, anak-anak, pekerja luar ruangan, dan atlet.
                  <br>
                  <br>
                  <strong>Tips menghindari dampak polusi (WHO):</strong>
                  <br>
                  - Hindari berjalan di jalanan ramai.
                  <br>
                  - Kurangi waktu di area lalu lintas padat.
                  <br>
                  - Pilih tempat berolahraga yang lebih bersih.
                  <br>
                  - Batasi penggunaan kendaraan di hari dengan polusi tinggi.
                  <br>
